...
const getTableData = ()=>{
  CommandApi.getCommandList({page:page.value, pageSize:pageSize.value, ...searchInfo.value}).then(res => {
  ...
  commandForm.value?.validate((valid: boolean) => {
    if (valid){
      switch(type.value){
        case 'add':
          {
            CommandApi.createCommand(form.value).then(
              (res:any) => {
                ElMessage({
                  type: 'success',
                  message: '添加成功!'
        ...
        case 'edit':
          {
            CommandApi.updateCommand(form.value).then(
              (res:any) => {
                ElMessage({
                  type: 'success',
                  message: '修改成功!'

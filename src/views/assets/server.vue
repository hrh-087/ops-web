    ...
    >
        ...
        >
          <template #default="scope">
            {{ scope.row.cloudProduce.cloudName }}-{{ scope.row.cloudProduce.regionName }}
          </template>
        </el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item
          ...
          required
        >
          <el-select v-model.number="form.cloudProduceId" placeholder="请选择" style="width: 100%">
            <el-option
        ...
        <el-form-item
          ...
          required
        >
          <el-select v-model.number="form.serverType" placeholder="请选择" style="width: 100%">
              <el-option
...
const rules = {
  ...
  serverType: [{ required: true, message: '请选择服务器类型', trigger: 'blur' },],
}

const getTableData = () => {
  AssetsServerApi.getAssetsServerList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  .then((res: any) => {

<template>
  ...
  <div class="ops-table-box">
    <div class="ops-btn-list">
      <el-button type="primary" icon="plus" @click="addAssetsKafka()">
        新增
      </el-button>
    </div>
  ...
  >
    ...
    >
      ...
      <el-form-item label="认证用户" prop="user" style="width: 70%">
        <el-input v-model="form.user" autocomplete="off" placeholder="用户" />
      </el-form-item>

      <el-form-item label="认证密码" prop="pass" style="width: 70%">
